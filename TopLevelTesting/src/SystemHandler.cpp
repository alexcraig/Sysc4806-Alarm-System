...
INLINE_METHODS void SystemHandler_Actor::transition4_EnablePressed( const void * rtdata, KeypadProtocol::Conjugate * rtport )
{
	// {{{USR
...
INLINE_METHODS void SystemHandler_Actor::transition6_False( const RTString * rtdata, KeypadProtocol::Conjugate * rtport )
{
	// {{{USR
...
INLINE_METHODS void SystemHandler_Actor::transition7_DisablePressed( const void * rtdata, KeypadProtocol::Conjugate * rtport )
{
	// {{{USR
	String displayMessage = "Please enter your password";
	toDisplay.display_string(displayMessage).send();
...
INLINE_METHODS void SystemHandler_Actor::transition9_True( const RTString * rtdata, KeypadProtocol::Conjugate * rtport )
{
	// {{{USR
...
INLINE_METHODS void SystemHandler_Actor::transition10_False( const RTString * rtdata, KeypadProtocol::Conjugate * rtport )
{
	// {{{USR
	String displayMessage = "Invalid password.";
	toDisplay.display_string(displayMessage).send();
...
INLINE_METHODS void SystemHandler_Actor::transition13_True( const RTString * rtdata, KeypadProtocol::Conjugate * rtport )
{
	// {{{USR
...
INLINE_METHODS void SystemHandler_Actor::transition16_ArmPressed( const void * rtdata, KeypadProtocol::Conjugate * rtport )
{
	// {{{USR
	String displayMessage = "Please enter your password";
	toDisplay.display_string(displayMessage).send();
...
INLINE_METHODS void SystemHandler_Actor::transition17_DisarmPressed( const void * rtdata, KeypadProtocol::Conjugate * rtport )
{
	// {{{USR
	String displayMessage = "Please enter your password";
	toDisplay.display_string(displayMessage).send();
...
INLINE_METHODS void SystemHandler_Actor::transition19_True( const RTString * rtdata, KeypadProtocol::Conjugate * rtport )
{
	// {{{USR
...
INLINE_METHODS void SystemHandler_Actor::transition20_False( const RTString * rtdata, KeypadProtocol::Conjugate * rtport )
{
	// {{{USR
	String displayMessage = "Invalid password";
	toDisplay.display_string(displayMessage).send();
...
INLINE_METHODS void SystemHandler_Actor::transition22_True( const RTString * rtdata, KeypadProtocol::Conjugate * rtport )
{
	// {{{USR
	String displayMessage = "System enabled and disarmed.";
	toDisplay.display_string(displayMessage).send();
...
INLINE_METHODS void SystemHandler_Actor::transition23_False( const RTString * rtdata, KeypadProtocol::Conjugate * rtport )
{
	// {{{USR
	String displayMessage = "Invalid password.";
	toDisplay.display_string(displayMessage).send();
...
INLINE_METHODS void SystemHandler_Actor::transition26_ArmedFailure( const PeripheralIdentifier * rtdata, HandlerProtocol::Base * rtport )
{
	// {{{USR
	const PeripheralIdentifier & failInfo = *rtdata;
...
INLINE_METHODS void SystemHandler_Actor::transition27_ArmedBreakin( const PeripheralIdentifier * rtdata, HandlerProtocol::Base * rtport )
{
	// {{{USR
	const PeripheralIdentifier & failInfo = *rtdata;
...
INLINE_METHODS void SystemHandler_Actor::transition30_FailedPhoneCall( const void * rtdata, PhoneProtocol::Conjugate * rtport )
{
	// {{{USR
	char displayBuffer[512];
...
INLINE_CHAINS void SystemHandler_Actor::chain4_EnablePressed( void )
{
	...
	exitState( rtg_parent_state );
	rtgTransitionBegin();
	transition4_EnablePressed( msg->data, (KeypadProtocol::Conjugate *)msg->sap() );
	rtgTransitionEnd();
	enterState( 10 );
}
...
INLINE_CHAINS void SystemHandler_Actor::chain7_DisablePressed( void )
{
	...
	exitState( rtg_parent_state );
	rtgTransitionBegin();
	transition7_DisablePressed( msg->data, (KeypadProtocol::Conjugate *)msg->sap() );
	rtgTransitionEnd();
	enterState( 11 );
}
...
INLINE_CHAINS void SystemHandler_Actor::chain16_ArmPressed( void )
{
	...
	exitState( rtg_parent_state );
	rtgTransitionBegin();
	transition16_ArmPressed( msg->data, (KeypadProtocol::Conjugate *)msg->sap() );
	rtgTransitionEnd();
	enterState( 8 );
}
...
INLINE_CHAINS void SystemHandler_Actor::chain27_ArmedBreakin( void )
{
	...
	exitState( rtg_parent_state );
	rtgTransitionBegin();
	transition27_ArmedBreakin( (const PeripheralIdentifier *)msg->data, (HandlerProtocol::Base *)msg->sap() );
	rtgTransitionEnd();
	enterState( 7 );
}
...
INLINE_CHAINS void SystemHandler_Actor::chain26_ArmedFailure( void )
{
	...
	exitState( rtg_parent_state );
	rtgTransitionBegin();
	transition26_ArmedFailure( (const PeripheralIdentifier *)msg->data, (HandlerProtocol::Base *)msg->sap() );
	rtgTransitionEnd();
	enterState( 7 );
}
...
INLINE_CHAINS void SystemHandler_Actor::chain17_DisarmPressed( void )
{
	...
	exitState( rtg_parent_state );
	rtgTransitionBegin();
	transition17_DisarmPressed( msg->data, (KeypadProtocol::Conjugate *)msg->sap() );
	rtgTransitionEnd();
	enterState( 9 );
}
...
INLINE_CHAINS void SystemHandler_Actor::chain30_FailedPhoneCall( void )
{
	...
	exitState( rtg_parent_state );
	rtgTransitionBegin();
	transition30_FailedPhoneCall( msg->data, (PhoneProtocol::Conjugate *)msg->sap() );
	rtgTransitionEnd();
	enterState( 7 );
}
...
INLINE_CHAINS void SystemHandler_Actor::chain18_PasswordEntered( void )
{
	...
	rtgTransitionBegin();
	rtgTransitionEnd();
	if( choicePoint3_ArmPasswordValidate( (const RTString *)msg->data, (KeypadProtocol::Conjugate *)msg->sap() ) )
		chain19_True();
	else
		chain20_False();
}
...
INLINE_METHODS int SystemHandler_Actor::choicePoint3_ArmPasswordValidate( const RTString * rtdata, KeypadProtocol::Conjugate * rtport )
{
	// {{{USR
...
INLINE_CHAINS void SystemHandler_Actor::chain19_True( void )
{
	...
	rtgTransitionBegin();
	transition19_True( (const RTString *)msg->data, (KeypadProtocol::Conjugate *)msg->sap() );
	rtgTransitionEnd();
	enterState( 7 );
}
...
INLINE_CHAINS void SystemHandler_Actor::chain20_False( void )
{
	...
	rtgTransitionBegin();
	transition20_False( (const RTString *)msg->data, (KeypadProtocol::Conjugate *)msg->sap() );
	rtgTransitionEnd();
	enterState( 6 );
}
...
INLINE_CHAINS void SystemHandler_Actor::chain21_PasswordEntered( void )
{
	...
	rtgTransitionBegin();
	rtgTransitionEnd();
	if( choicePoint4_DisarmPasswordValidate( (const RTString *)msg->data, (KeypadProtocol::Conjugate *)msg->sap() ) )
		chain22_True();
	else
		chain23_False();
}
...
INLINE_METHODS int SystemHandler_Actor::choicePoint4_DisarmPasswordValidate( const RTString * rtdata, KeypadProtocol::Conjugate * rtport )
{
	// {{{USR
	const String & password = *rtdata;
...
INLINE_CHAINS void SystemHandler_Actor::chain22_True( void )
{
	...
	rtgTransitionBegin();
	transition22_True( (const RTString *)msg->data, (KeypadProtocol::Conjugate *)msg->sap() );
	rtgTransitionEnd();
	enterState( 6 );
}
...
INLINE_CHAINS void SystemHandler_Actor::chain23_False( void )
{
	...
	rtgTransitionBegin();
	transition23_False( (const RTString *)msg->data, (KeypadProtocol::Conjugate *)msg->sap() );
	rtgTransitionEnd();
	enterState( 7 );
}
...
INLINE_CHAINS void SystemHandler_Actor::chain5_PasswordEntered( void )
{
	...
	rtgTransitionBegin();
	rtgTransitionEnd();
	if( choicePoint1_EnablePasswordValidate( (const RTString *)msg->data, (KeypadProtocol::Conjugate *)msg->sap() ) )
		chain13_True();
	else
		chain6_False();
}
...
INLINE_METHODS int SystemHandler_Actor::choicePoint1_EnablePasswordValidate( const RTString * rtdata, KeypadProtocol::Conjugate * rtport )
{
	// {{{USR
	const String & password = *rtdata;
...
INLINE_CHAINS void SystemHandler_Actor::chain13_True( void )
{
	...
	rtgTransitionBegin();
	transition13_True( (const RTString *)msg->data, (KeypadProtocol::Conjugate *)msg->sap() );
	rtgTransitionEnd();
	enterState( 5 );
...
INLINE_CHAINS void SystemHandler_Actor::chain6_False( void )
{
	...
	rtgTransitionBegin();
	transition6_False( (const RTString *)msg->data, (KeypadProtocol::Conjugate *)msg->sap() );
	rtgTransitionEnd();
	enterState( 4 );
}
...
INLINE_CHAINS void SystemHandler_Actor::chain8_PasswordEntered( void )
{
	...
	rtgTransitionBegin();
	rtgTransitionEnd();
	if( choicePoint2_DisablePasswordValidate( (const RTString *)msg->data, (KeypadProtocol::Conjugate *)msg->sap() ) )
		chain9_True();
	else
		chain10_False();
}
...
INLINE_METHODS int SystemHandler_Actor::choicePoint2_DisablePasswordValidate( const RTString * rtdata, KeypadProtocol::Conjugate * rtport )
{
	// {{{USR
	const String & password = *rtdata;
...
INLINE_CHAINS void SystemHandler_Actor::chain9_True( void )
{
	...
	rtgTransitionBegin();
	transition9_True( (const RTString *)msg->data, (KeypadProtocol::Conjugate *)msg->sap() );
	rtgTransitionEnd();
	enterState( 4 );
}
...
INLINE_CHAINS void SystemHandler_Actor::chain10_False( void )
{
	...
	rtgTransitionBegin();
	transition10_False( (const RTString *)msg->data, (KeypadProtocol::Conjugate *)msg->sap() );
	rtgTransitionEnd();
	enterState( 5 );
	processHistory();
}
