...
protected:
	...
	INLINE_METHODS void transition4_EnablePressed( const void * rtdata, RTProtocol * rtport );
	// }}}RME
	// {{{RME transition ':TOP:Initialized:EnablePasswordValidate:False'
	INLINE_METHODS void transition6_False( const RTString * rtdata, RTProtocol * rtport );
	// }}}RME
	// {{{RME transition ':TOP:Initialized:Enabled:J4D6E736B011E:DisablePressed'
	INLINE_METHODS void transition7_DisablePressed( const void * rtdata, RTProtocol * rtport );
	// }}}RME
	// {{{RME transition ':TOP:Initialized:DisablePasswordValidate:True'
	INLINE_METHODS void transition9_True( const RTString * rtdata, RTProtocol * rtport );
	// }}}RME
	// {{{RME transition ':TOP:Initialized:DisablePasswordValidate:False'
	INLINE_METHODS void transition10_False( const RTString * rtdata, RTProtocol * rtport );
	// }}}RME
	...
	INLINE_METHODS void transition13_True( const RTString * rtdata, RTProtocol * rtport );
	// }}}RME
	...
	INLINE_METHODS void transition16_ArmPressed( const void * rtdata, RTProtocol * rtport );
	// }}}RME
	// {{{RME transition ':TOP:Initialized:Enabled:Armed:J4D6E736B011E:DisarmPressed'
	INLINE_METHODS void transition17_DisarmPressed( const void * rtdata, RTProtocol * rtport );
	// }}}RME
	// {{{RME transition ':TOP:Initialized:Enabled:ArmPasswordValidate:True'
	INLINE_METHODS void transition19_True( const RTString * rtdata, RTProtocol * rtport );
	// }}}RME
	// {{{RME transition ':TOP:Initialized:Enabled:ArmPasswordValidate:False'
	INLINE_METHODS void transition20_False( const RTString * rtdata, RTProtocol * rtport );
	// }}}RME
	// {{{RME transition ':TOP:Initialized:Enabled:DisarmPasswordValidate:True'
	INLINE_METHODS void transition22_True( const RTString * rtdata, RTProtocol * rtport );
	// }}}RME
	...
	INLINE_METHODS void transition27_ArmedBreakin( const PeripheralIdentifier * rtdata, RTProtocol * rtport );
	// }}}RME
	...
	INLINE_METHODS void transition30_FailedPhoneCall( const void * rtdata, RTProtocol * rtport );
	// }}}RME
